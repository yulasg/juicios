...
Route::group(['middleware' => ['auth', 'activated', 'activity']], function () {
    ...
    */
    ...
    |-------------------------------------------------------------------------------------------------------------------------------------------
    */
    Route::get('juicios', [JuicioController::class, 'index'])->name('juicios.index');//->middleware('role:abogado');
    Route::get('juicios/create', [JuicioController::class, 'create'])->name('juicios.create');//->middleware('permission');
    Route::post('juicios', [JuicioController::class, 'store'])->name('juicios.store');//->middleware('role:abogado');
    ...
    Route::get('juicio/consultaseguimiento', [JuicioController::class, 'consultaseguimiento'])->name('juicios.consultaseguimiento');
    Route::get('juicio/consultajuicio', [JuicioController::class, 'consultajuicio'])->name('juicios.consultajuicio');
    Route::get('juicio/consultajuicioespecialidad', [JuicioController::class, 'consultajuicioespecialidad'])->name('juicios.consultajuicioespecialidad');
    ...
    */
    ...
    Route::get('relaciones/eliminar/{id}', [RelacionController::class, 'eliminar'])->name('relaciones.eliminar');//->middleware('permission:eliminar.relacionar');

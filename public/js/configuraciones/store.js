const formularioConfiguracion= document.getElementById('crearConfiguracion');
...
$(formularioConfiguracion.querySelector('[name="internacional"]')).on('change', function () {
    // Revalidate the field when an option is chosen
    validator.revalidateField('internacional');
});
$(formularioConfiguracion.querySelector('[name="especialidad_id"]')).on('change', function () {
    // Revalidate the field when an option is chosen

const formularioJuzgado= document.getElementById('crearJuzgado'); 
    ...
    formularioJuzgado,
    {
        fields: {
            'descripcion': {
                validators: {
                    notEmpty: {
                        message: 'La descripción del juzgado, es obligatorio'
                    },
                    stringLength: {
                        max: 50,
                        message: 'La descripción del juzgado, debe tener un máximo de 50 caracteres ',
                    }
                }
            }
        },

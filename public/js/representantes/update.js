...
// Define form element
const formulario = document.getElementById('actualizar_representante');
    ...
    if (validator) {
        validator.validate().then(function (status) {
            if (status == 'Valid') {
                ...
                const representante_id = $('#representante_id').val();
                const tipo = $('#tipo').val();
                ...
                $.ajax({
                    url: '/representante/editar/'+representante_id,
                    type: 'POST',
                    data: {
                        tipo: tipo,
                        numero: numeros,
                    ...
                    success: function (response) {
                        ...
                        if (type === 'success') {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    location.href = '/representantes/'+representante_id+'/edit';
                                }
                            });
                        }
                    }

        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <div class="d-flex flex-wrap flex-stack mb-6">
                    <!--begin::Heading-->
                    <h3 class="fw-bolder my-2">Estado Procesal</h3>
                    <!--end::Heading-->
                    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                        title="Click para incluir estado procesal">
                        <a href="{{ route('estados.create') }}" class="btn btn-sm btn-light btn-primary">
                            ...
                            <!--end::Svg Icon-->Nuevo Estado Procesal
                        </a>
                    </div>
                </div>
                            ...
                            <table id="tabla" class="table  table-striped table-row-bordered gy-5 gs-7 border rounded">
                                <thead>
                                    <tr class="fw-bolder text-muted">
                                        ...
                                        <th class="min-w-100px">Estado Procesal</th>
...
@push('pageScripts')
    ...
    <script src="{{ asset('js/estados/index.js') }}"></script>
    <script src="{{ asset('js/estados/eliminar.js') }}"></script>
@endpush

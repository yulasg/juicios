        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <div class="d-flex flex-wrap flex-stack mb-6">
                    <!--begin::Heading-->
                    <h3 class="fw-bolder my-2">Juzgados</h3>
                    <!--end::Heading-->
                    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                        title="Click para incluir juzgado">
                        <a href="{{ route('juzgados.create') }}" class="btn btn-sm btn-light btn-primary">
...
@push('pageScripts')
    ...
    <script src="{{ asset('js/juzgados/index.js') }}"></script>
    <script src="{{ asset('js/juzgados/eliminar.js') }}"></script>
@endpush

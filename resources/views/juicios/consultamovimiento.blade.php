        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <div class="d-flex flex-wrap flex-stack mb-6">
                    <!--begin::Heading-->
                    <h3 class="fw-bolder my-2">Consulta de Juicios con Última Actividad</h3>
                    <!--end::Heading-->
                </div>
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <!--<div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1">Consulta de Juicios con Última Actividad</span>
                            </h3>
                        </div>-->
                    <!--end::Header-->
                    <!--begin::Body-->
                            ...
                            <table id="tabla"
                                ...
                                <thead>
                                    <tr class="fw-bold fs-6 text-gray-800">
                                        ...
                                        <th class="min-w-25px">Id Actividad</th>
                                        ...
                                        <th class="min-w-50px">Última Actividad</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
...
@push('pageScripts')
    ...
    <script src="{{ asset('js/juicios/consultamovimiento.js') }}"></script>
@endpush

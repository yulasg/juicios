        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <div class="d-flex flex-wrap flex-stack mb-6">
                    <!--begin::Heading-->
                    <h3 class="fw-bolder my-2">Consulta de Juicios con Última Actuación</h3>
                    <!--end::Heading-->
                </div>
                ...
                <div class="card mb-5 mb-xl-8">
                    <!--begin::Header
                                <div class="card-header border-0 pt-5">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bolder fs-3 mb-1">Consulta de Juicios con Última Actuación</span>
                                    </h3>
                                </div>-->
                    <!--end::Header-->
                    ...
                    <div class="card-body py-3">
                        ...
                        <div class="table-responsive">
                            <table id="tabla" class="table  table-striped  table-row-bordered gy-5 gs-7 ">
                                <thead>
                                    <tr class="fw-bold fs-6 text-gray-800">
                                        <!--<th class="min-w-50px">Acciones</th>-->
                                        <th class="min-w-25px">Id Juicio</th>
                                        <th class="min-w-25px">Id Actuación</th>
                                        ...
                                        <th class="min-w-50px">Fecha Creación Actuación</th>
                                        <th class="min-w-50px">Fecha Última Actuación</th>
                                        <th class="min-w-50px">Actividad Procesal</th>
                                        <th class="min-w-50px">Última Actuación</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
...
@push('pageScripts')
    ...
    <script src="{{ asset('js/juicios/consultaseguimiento.js') }}"></script>
@endpush

        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="d-flex flex-wrap flex-stack mb-6">
                    <!--begin::Heading-->
                    <h3 class="fw-bolder my-2">Crear Representante</h3>
                    <!--end::Heading-->
                </div>
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-body  pt-5">
                        <!--begin::Form-->
                        <form action="{{ route('representantes.store') }}" class="form mb-15 " method="POST"
                            id="registrar_representante" name="registrar_representante">
                            @csrf
                            <!--begin::Input group-->
                            <div class="row mb-5">
                                <!--begin::Col-->
...
@push('pageScripts')
    <script src="{{ asset('js/representantes/store.js') }}"></script>

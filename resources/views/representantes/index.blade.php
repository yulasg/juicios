        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <div class="d-flex flex-wrap flex-stack mb-6">
                    <!--begin::Heading-->
                    <h3 class="fw-bolder my-2">Registros de Representantes</h3>
                    <!--end::Heading-->
                    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                        title="Click para incluir parte procesal">
                        <a href="{{ route('representantes.create') }}" class="btn btn-sm btn-light btn-primary">
                            ...
                            <!--end::Svg Icon-->Nuevo Representante
                        </a>
                    </div>
                </div>
...
@push('pageScripts')
    ...
    <script src="{{ asset('js/representantes/index.js') }}"></script>
    <script src="{{ asset('js/representantes/eliminar.js') }}"></script>
@endpush

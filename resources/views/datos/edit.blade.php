        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <div class="d-flex flex-wrap flex-stack mb-6">
                    <!--begin::Heading-->
                    <h3 class="fw-bolder my-2">Juicio N° {{ $JuicioDato->dato->juicio_id }}
                        <span class="fs-6 text-gray-400 fw-bold ms-1">Editar Datos</span>
                    </h3>
                    <!--end::Heading-->
                </div>
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-body py-3">
                        <!--begin::Form-->
                        <form action="/dato/editar/{{ $JuicioDato->dato->id }}" method="POST" name="actualizar_dato"
                            id="actualizar_dato">
                            <input type="hidden" name="dato_id" id="dato_id" value="{{ $JuicioDato->dato->id }}">
                            @csrf
                            <!--begin::Input group-->
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <div class="flex-grow-1">
                                            <input type="text"
                                                ...
                                                value="{{ old('capital', $JuicioDato->dato->capital) }}">
                                        </div>
                                    </div>
                                </div>
                                <!--end::Col-->
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <div class="flex-grow-1">
                                            <input type="text" class="form-control form-control-sm rounded-start-0"
                                                id="monto" name="monto"
                                                value="{{ old('capital', $JuicioDato->dato->monto) }}">
                                        </div>
                                    </div>
                                </div>
                                <!--end::Col-->
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <div class="flex-grow-1">
                                            <select class="form-select form-select-sm rounded-start-0"
                                                ...
                                                <option></option>
                                                <option {{ $JuicioDato->dato->tasa == 'Fija' ? 'selected' : '' }}
                                                    value="F">
                                                    Fija</option>
                                                <option {{ $JuicioDato->dato->tasa == 'Variable' ? 'selected' : '' }}
                                                    value="V">
                                                    Variable</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <div class="flex-grow-1">
                                            <input type="text" class="form-control form-control-sm rounded-start-0"
                                                ...
                                                value="{{ old('interes', $JuicioDato->dato->interes) }}">
                                        </div>
                                    </div>
                                </div>
                                <!--end::Col-->
                                ...
                                <div class="col-sm-4 fv-row">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <div class="flex-grow-1">
                                            <input type="text" class="form-control form-control-sm rounded-start-0"
                                                id="mora" name="mora"
                                                value="{{ old('mora', $JuicioDato->dato->mora) }}">
                                        </div>
                                    </div>
                                </div>
                                <!--end::Col-->
                                ...
                                <div class="col-sm-12 fv-row">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <div class="flex-grow-1">
                                            <input type="text" class="form-control form-control-sm rounded-start-0"
                                                id="juez" name="juez"
                                                value="{{ old('juez', $JuicioDato->dato->juez) }}">
                                        </div>
                                    </div>
                                </div>
                                <!--end::Col-->
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-sm-12 fv-row">
                                    <div class="flex-grow-1">
                                        ...
                                        <textarea class="form-control form-control-solid" rows="8" name="observacion" id="observacion">{{ $JuicioDato->dato->observacion }}</textarea>
                                    </div>
                                </div>
                                <!--end::Col-->
                            </div>
...
@push('pageScripts')
    ...
    <script src="{{ asset('js/datos/update.js') }}"></script>

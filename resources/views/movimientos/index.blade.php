            ...
            <div id="kt_content_container" class="container-xxl">
                <div class="d-flex flex-wrap flex-stack mb-6">
                    ...
                    <h3 class="fw-bolder my-2">Juicio N° {{ $dataJuicio }} 
                        <span class="fs-6 text-gray-400 fw-bold ms-1">Actividades</span>
                    </h3>
                    <!--end::Heading-->
                    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                        title="Click para incluir actividad">
                        <a href="{{ route('movimientos.create', $dataJuicio) }}" class="btn btn-sm btn-light btn-primary">
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-body py-3">
                        ...
                        <div class="table-responsive">
                            <table id="tabla_movimientos" name="tabla_movimientos"
                                class="table  table-striped table-row-bordered gy-5 gs-7 border rounded">
                                <thead>
                                    <tr class="fw-bold fs-6 text-gray-800">
                                        <th class="min-w-50px">Id</th>
                                        <th class="min-w-75px">Fecha</th>
                                        <th class="min-w-75px">Usuario</th>
...
@push('pageScripts')
    ...
    <script src="{{ asset('js/movimientos/eliminar.js') }}"></script>

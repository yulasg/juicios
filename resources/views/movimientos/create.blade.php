            ...
            <div id="kt_content_container" class="container-xxl">
                <div class="d-flex flex-wrap flex-stack mb-6">
                    ...
                    <h3 class="fw-bolder my-2">Juicio N° {{ $dataJuicio }} 
                        <span class="fs-6 text-gray-400 fw-bold ms-1">Crear Actividad</span>
                    </h3>
                    <!--end::Heading-->
                </div>
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-body py-3">
                        <!--begin::Form-->
                        <form action="{{ route('movimientos.store') }}" class="form mb-15 " method="POST"
                            id="registrar_movimiento" name="registrar_movimiento">
                            @csrf
                            ...
                            <div class="row mb-5">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <div class="flex-grow-1">
                                            <input type="text" class="form-control form-control-sm rounded-start-0"
                                                placeholder="Destino" id="destino" name="destino" />
                                        </div>
                                    </div>
                                </div>
                                <!--end::Col-->
                                ...
                                <div class="col-sm-6 fv-row">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <div class="flex-grow-1">
                                            <input type="text" class="form-control form-control-sm rounded-start-0"
                                                placeholder="Asunto" id="asunto" name="asunto" />
                                        </div>
                                    </div>
                                </div>
                                <!--end::Col-->
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-sm-6 fv-row">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <div class="flex-grow-1">
                                            <input type="text" class="form-control form-control-sm rounded-start-0"
                                                placeholder="Otra referencia" id="referencia2" name="referencia2" />
                                        </div>
                                    </div>
                                </div>
                                <!--end::Col-->
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <div class="flex-grow-1">
                                            <input type="time" class="form-control form-control-sm rounded-start-0"
                                                id="hora" name="hora" value="{{ date('H:i:s') }}">
                                        </div>
                                    </div>
                                </div>
                                <!--end::Col-->
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-sm-4 fv-row">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <div class="flex-grow-1">
                                            <input type="date" class="form-control form-control-sm rounded-start-0"
                                                id="fecha" name="fecha" value="{{ date('Y-m-d') }}">
                                        </div>
                                    </div>
                                </div>
                                <!--end::Col-->
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-sm-12 fv-row">
                                    <div class="flex-grow-1">
                                        ...
                                        <textarea class="form-control form-control-solid" rows="9" name="movimiento" id="movimiento"></textarea>
                                    </div>
                                </div>
                                <!--end::Col-->
                            </div>

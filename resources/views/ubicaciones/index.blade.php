        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <div class="d-flex flex-wrap flex-stack mb-6">
                    <!--begin::Heading-->
                    <h3 class="fw-bolder my-2">Estados</h3>
                    <!--end::Heading-->
                    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                        title="Click para incluir el estado">
                        <a href="{{ route('ubicaciones.create') }}" class="btn btn-sm btn-light btn-primary">
...
@push('pageScripts')
    ...
    <script src="{{ asset('js/ubicaciones/eliminar.js') }}"></script>
@endpush

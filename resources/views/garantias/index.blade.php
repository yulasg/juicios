        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <div class="d-flex flex-wrap flex-stack mb-6">
                    <!--begin::Heading-->
                    <h3 class="fw-bolder my-2">Tipo de Garantías</h3>
                    <!--end::Heading-->
                    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                        title="Click para incluir tipo de garantía">
                        <a href="{{ route('garantias.create') }}" class="btn btn-sm btn-light btn-primary">
                            ...
                            <!--end::Svg Icon-->Nuevo Tipo de Garantía
                        </a>
                    </div>
                </div>
...
@push('pageScripts')
    ...
    <script src="{{ asset('js/garantias/index.js') }}"></script>
    <script src="{{ asset('js/garantias/eliminar.js') }}"></script>
@endpush

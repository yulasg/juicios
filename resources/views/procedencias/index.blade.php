        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <div class="d-flex flex-wrap flex-stack mb-6">
                    <!--begin::Heading-->
                    <h3 class="fw-bolder my-2">Procedencias</h3>
                    <!--end::Heading-->
                    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                        title="Click para incluir procedencia">
                        <a href="{{ route('procedencias.create') }}" class="btn btn-sm btn-light btn-primary">
                            ...
                            <!--end::Svg Icon-->Nueva Procedencia
                        </a>
                    </div>
                </div>
                            ...
                            <table id="tabla" class="table  table-striped table-row-bordered gy-5 gs-7 border rounded">
                                <thead>
                                    <tr class="fw-bolder text-muted">
                                        ...
                                        <th class="min-w-100px">Procedencia</th>
...
@push('pageScripts')
    ...
    <script src="{{ asset('js/procedencias/index.js') }}"></script>
    <script src="{{ asset('js/procedencias/eliminar.js') }}"></script>
@endpush

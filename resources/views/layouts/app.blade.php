                        ...
                        <div class="aside-user-info flex-row-fluid flex-wrap ms-5">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 me-2">
                                    <!--begin::Username-->
                                    <a href="#"
                                        class="text-white text-hover-primary fs-6 fw-bold">{{ Auth::user()->nombre_completo }}</a>
                                    <!--end::Username-->
                                    <span
                                        class="text-gray-600 fw-bold d-block fs-8 mb-1">{{ Auth::user()->roles[0]->description }}</span>
                                ...
                                <div class="me-n2">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                                        ...
                                        <div class="menu-item px-5">
                                            <a href="../../demo8/dist/account/overview.html" class="menu-link px-5">Mi
                                                perfil</a>
                                        </div>
                                        --}}
                                        <!--end::Menu item-->
                                        ...
                                        <div class="menu-item px-5 my-1">
                                            <a href="../../demo8/dist/account/settings.html"
                                                class="menu-link px-5">Configuraciones de la cuenta</a>
                                        </div>
                                        --}}
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                ...
                <div id="kt_header" style="" class="header align-items-stretch">
                    ...
                    <div class="header-brand">
                        ...
                        <a href="{{ route('inicio') }}">
                            ...
                            <!--<img alt="Logo" src="media/logo_dark.png" class="h-50px h-lg-50px" />-->
                            <img alt="Logo" src="{{ asset('media/logo_dark.png') }}" class="h-50px h-lg-50px" />
                    ...
                    <div class="toolbar">
                        ...
                        <div
                            ...
                            <div class="page-title d-flex flex-column me-5">
                                <!--begin::Title-->
                                <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">FOGADE - Juicios</h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                                    ...
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <li class="breadcrumb-item text-dark">Defecto</li>
                                    <!--end::Item-->
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="https://keenthemes.com" target="_blank"
                                class="text-gray-800 text-hover-primary">Fogade</a>
                        </div>
                        <!--end::Copyright-->
